                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard.php">Update Petugas</a></li>
                        ...
                        <div class="row justify-content-center mt-3">
                            <div class="col-md-6">
                                ...
                                <div class="card card-primary">
                                    ...
                                    include '../../config.php';
                                    $id = $_GET['id'];
                                    $sql = mysqli_query($conn, "SELECT * FROM admin where id_admin = '$id'");
                                    ...
                                    <form class="form" action="../../controller/tambah.php" method="POST">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control" id="exampleInputEmail1" name="id" value="<?=$row['id_admin']?>">
