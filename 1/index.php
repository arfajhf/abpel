    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-6 text-center">
                <h1 class="text-info">AbPel</h1>
                <h5>(absenkan diri kamu sebelum masuk kelas!!!)</h5>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body justify-content-center">
                        ...
                        <form id="form" method="POST" action="masuk.php">
                            ...
                            <div class="form-group text-center">
                                <select name="pelajaran" id="pelajaran" class="pelajaran  form-control">
                            ...
                            <br>
                            <hr>
                            <button type="submit" class="tombol-simpan btn btn-primary" >Absen</button>
                        </form>
                    </div>
                </div>
            </div>
